(function() {
    ...
    // THE ULTIMATE OMNI-SCANNER (Checks Code + URL)
    const checkPage = () => {
        // Reads the hidden HTML code generated by Shopify (Descriptions, hidden tags, etc.)
        const backgroundCode = document.documentElement.innerHTML.toLowerCase();
        // Reads the actual URL at the top of the browser
        const fullUrl = window.location.href.toLowerCase();
        
        // If "vton" is in the code OR in the URL, trigger it!
        const hasVtonTag = backgroundCode.includes('vton') || fullUrl.includes('vton');
